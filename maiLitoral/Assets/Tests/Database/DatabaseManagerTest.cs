...
//         string propertyNameEn = UniqueName("BoolProperty"); string propertyNameRo = UniqueName("ProprietateBooleana");
//         databaseManager.CreateCalendarDayIfMissing(beach.Id, date); // Creates an existing day before adding the property
//         databaseManager.AddPropertyToAllBeaches(propertyNameEn, propertyNameRo, "bool");
//         List<(string description, bool status)> properties = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
//         Assert.IsTrue(properties.Exists(property => property.description == propertyNameEn)); // New property should exist on the day
//     }
//     [Test]
...
//         string propertyNameEn = UniqueName("BeachDayProperty"); string propertyNameRo = UniqueName("BeachDayProperty");
//         databaseManager.AddPropertyForBeachDay(beach.Id, date, propertyNameEn, propertyNameRo, "bool", true); // Adds the property as true
//         List<(string description, bool status)> firstResult = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
//         Assert.IsTrue(firstResult.Exists(property => property.description == propertyNameEn && property.status == true));
//         databaseManager.AddPropertyForBeachDay(beach.Id, date, propertyNameEn, propertyNameRo, "bool", false); // Updates the same property to false
//         List<(string description, bool status)> secondResult = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
//         Assert.IsTrue(secondResult.Exists(property => property.description == propertyNameEn && property.status == false));
//     }
//     [Test]
...
//         databaseManager.AddPropertyForBeachDay(beach.Id, date, oldName, oldName, "bool", false);
//         databaseManager.ModifyPropertyForBeachDay(beach.Id, date, oldName, newName, newName, true);
//         List<(string description, bool status)> properties = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
...
//         string propertyNameEn = UniqueName("DeleteProperty");
//         databaseManager.AddPropertyForBeachDay(beach.Id, date, propertyNameEn, propertyNameEn, true);
//         List<(string description, bool status)> beforeDelete = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
//         Assert.IsTrue(beforeDelete.Exists(property => property.description == propertyNameEn)); // Property should exist before deletion
//         databaseManager.DeletePropertyFromAllBeaches(propertyNameEn);
//         List<(string description, bool status)> afterDelete = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
//         Assert.IsFalse(afterDelete.Exists(property => property.description == propertyNameEn)); // Property should be gone after deletion
//     }
//     [Test]
...
//         string propertyNameEn = UniqueName("DeleteAllBeachProperty");
//         databaseManager.AddPropertyForBeachDay(beach.Id, date, propertyNameEn, propertyNameEn, "bool", true);
//         List<(string description, bool status)> beforeDelete = databaseManager.GetPropertiesForBeachDay(beach.Id, date);
